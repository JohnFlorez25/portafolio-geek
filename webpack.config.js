...
module.exports = {
  ...
  output: {
    ...
    //y ahi crea una carpeta "build" donde se va a guardar nuestro
    //proyecto
    ...
    rules: [
      {
        ...
        //y vamos a utilizar el loader que utilizamos en babel
        use: {
          loader: 'babel-loader',
        },
      },
  ...
  //vamos a generar en la carpeta dist - build para enviar a produccion
  plugins: [
